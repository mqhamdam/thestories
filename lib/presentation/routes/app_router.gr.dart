...
import '../pages/compose_story/compose_story_page.dart' as _i7;
import '../pages/infinite_stroy_list/infinite_story_list_page.dart' as _i3;
import '../pages/notifications/notifications_page.dart' as _i12;
import '../pages/profile/profile_page.dart' as _i13;
import '../pages/reading/reading_page.dart' as _i8;
import '../pages/search/global_search_page.dart' as _i11;
...
import '../pages/stories/stories_page.dart' as _i10;
...
class AppRouter extends _i14.RootStackRouter {
  ...
  final Map<String, _i14.PageFactory> pagesMap = {
    ...
    ComposeStoryScreenRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i7.ComposeStoryScreen());
    },
    ReadingScreenRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i8.ReadingScreen());
    },
    ...
    StoriesScreenRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i10.StoriesScreen());
    },
    GlobalSearchScreenRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i11.GlobalSearchScreen());
    },
    NotificationsScreenRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i12.NotificationsScreen());
    },
  ...
  List<_i14.RouteConfig> get routes => [
        _i14.RouteConfig(AuthenticationScreenRoute.name,
            path: '/authentication-screen'),
        _i14.RouteConfig(InitialScreenRoute.name, path: '/', children: [
          _i14.RouteConfig(StoriesScreenRoute.name, path: 'stories-screen'),
          _i14.RouteConfig(GlobalSearchScreenRoute.name,
              path: 'global-search-screen'),
          _i14.RouteConfig(NotificationsScreenRoute.name,
              path: 'notifications-screen'),
          _i14.RouteConfig(ProfileScreenRoute.name, path: 'profile-screen')
        ]),
        _i14.RouteConfig(InfiniteStoryListScreenRoute.name,
            path: '/infinite-story-list-screen'),
        _i14.RouteConfig(SpecialStoryScreenRoute.name,
            path: '/special-story-screen'),
        _i14.RouteConfig(AchievementsScreenRoute.name,
            path: '/achievements-screen'),
        _i14.RouteConfig(AccountSettingsScreenRoute.name,
            path: '/account-settings-screen'),
        _i14.RouteConfig(ComposeStoryScreenRoute.name,
            path: '/compose-story-screen'),
        _i14.RouteConfig(ReadingScreenRoute.name, path: '/reading-screen'),
        _i14.RouteConfig(SettingsScreenRoute.name, path: '/settings-screen')
      ];
}

/// generated route for [_i1.AuthenticationScreen]
class AuthenticationScreenRoute extends _i14.PageRouteInfo<void> {
...
class InitialScreenRoute extends _i14.PageRouteInfo<void> {
  const InitialScreenRoute({List<_i14.PageRouteInfo>? children})
...
class InfiniteStoryListScreenRoute extends _i14.PageRouteInfo<void> {
...
class SpecialStoryScreenRoute extends _i14.PageRouteInfo<void> {
...
class AchievementsScreenRoute extends _i14.PageRouteInfo<void> {
...
class AccountSettingsScreenRoute extends _i14.PageRouteInfo<void> {
...
/// generated route for [_i7.ComposeStoryScreen]
class ComposeStoryScreenRoute extends _i14.PageRouteInfo<void> {
  const ComposeStoryScreenRoute() : super(name, path: '/compose-story-screen');

  static const String name = 'ComposeStoryScreenRoute';
}

/// generated route for [_i8.ReadingScreen]
class ReadingScreenRoute extends _i14.PageRouteInfo<void> {
  const ReadingScreenRoute() : super(name, path: '/reading-screen');

  static const String name = 'ReadingScreenRoute';
}

/// generated route for [_i9.SettingsScreen]
...
/// generated route for [_i10.StoriesScreen]
class StoriesScreenRoute extends _i14.PageRouteInfo<void> {
  const StoriesScreenRoute() : super(name, path: 'stories-screen');

  static const String name = 'StoriesScreenRoute';
}

/// generated route for [_i11.GlobalSearchScreen]
class GlobalSearchScreenRoute extends _i14.PageRouteInfo<void> {
  const GlobalSearchScreenRoute() : super(name, path: 'global-search-screen');

  static const String name = 'GlobalSearchScreenRoute';
}

/// generated route for [_i12.NotificationsScreen]
...
/// generated route for [_i13.ProfileScreen]
